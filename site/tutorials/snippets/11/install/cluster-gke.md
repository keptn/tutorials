...
2. Create GKE cluster
  ...
  - Image type `ubuntu` or `cos` (**Note:** If you plan to use Dynatrace monitoring, select `ubuntu` for a more [convenient setup](https://keptn.sh/docs/0.11.x/monitoring/dynatrace/install/#notes).)
