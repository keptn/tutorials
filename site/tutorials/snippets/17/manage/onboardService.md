...
1. Create the **carts** service using the [keptn create service](https://keptn.sh/docs/0.17.x/reference/cli/commands/keptn_create_service/) and [keptn add-resource](https://keptn.sh/docs/0.17.x/reference/cli/commands/keptn_add-resource/)commands:
...
* Create the **carts-db** service using the [keptn create service](https://keptn.sh/docs/0.17.x/reference/cli/commands/keptn_create_service/) and [keptn add-resource](https://keptn.sh/docs/0.17.x/reference/cli/commands/keptn_add-resource/)commands.
