...
Positive
: Please note that the Keptn endpoint can also be publicly exposed. All details can be found in the [Keptn docs](https://keptn.sh/docs/0.13.x/operate/install/).
