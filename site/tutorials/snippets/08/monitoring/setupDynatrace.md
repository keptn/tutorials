...
1. Downloading the automation file.
    ...
    <!-- command -->
    ```
    curl -o deploy-dynatrace-oneagent.sh https://raw.githubusercontent.com/keptn/examples/release-0.8.0-alpha/dynatrace-oneagent/deploy-dynatrace-oneagent.sh
    ```
