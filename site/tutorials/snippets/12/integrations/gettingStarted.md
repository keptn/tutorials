...
Keptn can be easily extended with external tools such as notification tools, other [SLI providers](https://keptn.sh/docs/0.12.x/quality_gates/sli/), bots to interact with Keptn, etc.
