...
```
git clone --branch 0.12.0 https://github.com/keptn/examples.git --single-branch
...
To configure a Git upstream for this tutorial, the Git user (`--git-user`), an access token (`--git-token`), and the remote URL (`--git-remote-url`) are required. If a requirement is not met, go to [the Keptn documentation](https://keptn.sh/docs/0.12.x/manage/git_upstream/) where instructions for GitHub, GitLab, and Bitbucket are provided.
