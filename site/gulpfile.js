...
const DEFAULT_GA = 'UA-133584243-1';
...
// trailing slash.
const BASE_URL = args.baseUrl || 'https://tutorials.keptn.sh';
...
// flag.
const CODELABS_DIR = args.codelabsDir || './tutorials';
...
const CODELABS_NAMESPACE = (args.codelabsNamespace || 'tutorials').replace(/^\/|\/$/g, '');
